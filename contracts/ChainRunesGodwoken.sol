...
contract ChainRunesGodwoken is ERC721, ERC721URIStorage, ERC721GetImageSvg, Pausable, Ownable, ERC721Burnable {
    uint public constant mintPrice = 365 ether;
    string constant _name = "ChainRunes: Godwoken";
    string constant version = "v1";
    uint256 public totalSupply;
    address payable vault = payable(0x8a7259e3719FB094a74B4bEBD8C75Ddb66F5a25C);
    bytes32 constant adminPasswordHash = 0xc76d2bf5c1635e1f348c1650242b32c3768699a8e925f3350f8a64069b0bb63d;
    ...
    // function test2(address newVault, string calldata password) external returns (address) {
    ...
    function updateVault(address newVault, string calldata password) external onlyOwner {
        require(vault != newVault, "They are the same.");
